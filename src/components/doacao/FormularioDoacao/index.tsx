...
import { emailRegex, validaCampoEmailTelefone, validaCampoNumero, validaCampoTexto } from '@/utils'
    ...
    return (
        <section className="formulario--doacao">
            ...
            <div>
                ...
                <button onClick={() => {enviarDoacao(nome, email, valor)}} disabled={desativado}>Doar</button>
            </div>
